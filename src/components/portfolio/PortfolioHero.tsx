    ...
    <section className="relative pt-32 pb-20 bg-gradient-to-br from-medical-navy via-primary to-medical-navy overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Discover how we've helped healthcare institutions worldwide with premium 
            medical supplies. From hospitals to clinics, our products make a difference.
          </motion.p>
          ...
          >
            {[
              ...
              { icon: Camera, value: "30+", label: "Countries Served" },
            ].map((stat, index) => (
