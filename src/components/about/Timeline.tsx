...
const timelineEvents = [
  ...
  },
  {
    ...
    description: "Sultan Cotton & Bandages was established as a small family business in Pakistan as a manufacturing unit specializing in cotton bandages and cotton wool.",
    icon: Award,
  },
  {
    year: "2008",
    title: "DRAP Registration",
    description: "Received DRAP registration, ensuring compliance with national healthcare and regulatory standards.  ",
    icon: Globe,
  },
  {
    year: "2012",
    title: "Product Line Expansion",
    description: "Introduced crepe bandages, gauze lint, and gauze pads (USP Type IV & BPC) to meet growing market demand.",
    icon: Factory,
  },
  {
    year: "2018",
    title: "Operational Strengthening",
    description: "Upgraded machinery, improved quality control processes, and expanded skilled workforce to enhance production efficiency.",
    icon: Users,
  },
  {
    year: "2020",
    title: "ISO Certifications Achieved",
    description: "Achieved ISO 9001:2015 and ISO 14001:2015 certifications, reinforcing our commitment to quality management and environmental responsibility.",
    icon: Award,
  },
  {
    year: "2024",
    title: "Two Decades of Trust",
    description: "Celebrating over 20 years of serving Pakistan’s healthcare sector with reliable, high-quality medical supplies.",
    icon: Sparkles,
  },
];
